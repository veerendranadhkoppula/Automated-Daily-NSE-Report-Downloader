...
Pdddmmyy.csv file also contains Symbol and Series codes for each Security in addition to the information contained in the prddmmyy.csv file. 52 week high & 52 week low prices are not adjusted for Bonus, Split & Rights corporate actions

Prddmmyy.csv file contains security wise market data information along with the Index details. 52 week high & 52 week low prices are not adjusted for Bonus, Split & Rights corporate actions
...
PE_ddmmyy.csv file contains list of Companies indicated with its Symbol, Symbol P/E and Adjusted P/E where,Symbol P/E ratio is computed considering consecutive four quarters Net Profit, issued capital and previous day closing price of the Company. Adjusted P/E ratio is computed considering consecutive four quarters Net Profit after adjustment of Exceptional items (net of tax), issued capital and previous day closing price of the Company.

MCAPDDMMYYYY.csv file contains market capitalization of all the listed and permitted companies of the exchange by using latest available price.
